...
#<span style="color:skyblue; font-weight:bold">Retrieval for Return Stock database flow</span>
**Abbreviation:**
- **WRKI** : DNWORKINFO  
- **WRKL** : DNWORKINFOLIST  
- **PLLT** : DNPALLET  
...
|---------------------------------------------------------------------------------|----|----|----|----|----|----|-----|----|----|----|----|----|----|----|-----|
| ID63 [(1)](#ID63)                                                               |    |    |    |    |    |    |     |    |    |    |    | U  |    |    |     |
| Retrieval for Return Stock - Set(F2) [(1)](#Retrieval-for-Return-Stock--Set(F2))       | I  | I  | S  | I  | U  |    |     | S  | S  |    | S  | S  | S  |    |     |
...
- [QC Work from Retrieval for Return Stock](https://dev.azure.com/Daifuku-SW/ID_SimeDarbyPlantation/_wiki/wikis/ID_SimeDarbyPlantation.wiki/962/QC-Work-from-Retrieval-for-Return-Stock)
