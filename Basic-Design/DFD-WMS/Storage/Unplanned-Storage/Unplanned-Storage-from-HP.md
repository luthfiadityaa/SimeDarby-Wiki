...
| **DEST_STATION_NO**            | <span style="color:yellow; font-weight:bold">Based on SOURCE_STATION_NO where a reserved location belongs to ⟶ (7207, 7208, 7209, 7210, 7211, 7212, 7213, 7214)</span>
...
| **CMD_STATUS**                 | 1:Started 
| **CARRY_FLAG**                 | 3: Direct Transfer
| **SOURCE_STATION_NO**          | DNARRIVAL.STATION_NO ⟶ <span style="color:yellow; font-weight:bold">(7207, 7208, 7209, 7210)</span>
| **DEST_STATION_NO**            | <span style="color:yellow; font-weight:bold">Based on SOURCE_STATION_NO where a reserved location belongs to ⟶ (7101, 7102, 7103, 7104)</span>
| **REGIST_DATE**                | SYSTIMESTAMP                                                    
| **REGIST_PNAME**               | ClassName
| **LAST_UPDATE_DATE**           | SYSTIMESTAMP
| **LAST_UPDATE_PNAME**          | ClassName
