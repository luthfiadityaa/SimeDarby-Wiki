...
* **ITEM_CODE**              = Value from screen (***Material Code*8)
* **PLAN_LOT_NO**            = Value from screen (**Batch #**)
* **PLAN_QTY**               = Value from screen (**Planned Carton Qty**)
* **SAP_TO_LOCATION**        = Value from screen (**Storage Location**) 
* **PLAN_AREA_NO**           = Followed by Storage Location (**System Decided**) --> **FGW1 (Ambient/9002)** or **FGW2 (Tempering/9001)**
...
* **BATCH_START_DATETIME** : **PLAN_DAY + value from screen (**Storage Time**) --> **HHmmss** 
