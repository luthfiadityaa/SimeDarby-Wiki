...
| **DEST_STATION_NO**            | <span style="color:yellow; font-weight:bold">SOURCE_STATION_NO where a reserved location belongs to ⟶ (7211, 7012, 7213, 7214) or (7101, 7102, 7103, 7104, 7105, 7106)</span>
</span>
| **LAST_UPDATE_DATE**           | SYSTIMESTAMP
| **LAST_UPDATE_PNAME**          | Class name
