...
Since the process is identical, avoid duplicating content. Begin with the Palletize Start step starting at <span style="color:green; font-weight:bold">ID26</span>, and then return to this batch when approaching ID33 to continue with the subsequent process.
