...
Since the process is identical, avoid duplicating content. Begin with the Palletize Start step starting at ID26, and then return to this batch when approaching ID33 to continue with the subsequent process.
